...
<div class="last stack bio">
    ...
    <ul class="contact">
        ...
        <li><a href="/media/docs/resume-danielcanet-v1.1.0.pdf" title="Download Resume (PDF)">Resume</a></li>
    </ul>
    <ul class="resume">
        <li><a class="btn" href="/media/docs/resume-danielcanet-v1.1.0.pdf" title="Download Resume (PDF)">Resume<small>(PDF)</span></a></li>
    </ul>
</div>
